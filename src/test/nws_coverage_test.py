...
from nws_manager import Forecaster

start_time = datetime.datetime.now()
mappings = []
with open('../../data/airport_mappings.json', 'r') as mappings_f:
...
f = Forecaster('../../data/airport_mappings.json')
...
print(f'Completed in {datetime.datetime.now().timestamp() - start_time.timestamp()}s')